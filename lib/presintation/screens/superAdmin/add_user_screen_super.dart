...
class AddUserScreenSuper extends StatelessWidget {
  final String clientId; // Add clientId parameter
  const AddUserScreenSuper({super.key, required this.clientId});
  ...
  Widget build(BuildContext context) {
    ...
    // Set the clientId in the cubit
    cubit.clientId = clientId;
